...
<html>
	...
	<body>
		<a href="#list-cardPlatform" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-cardPlatform" class="content scaffold-list" role="main">
			...
			<table>
				...
				<g:each in="${cardPlatformInstanceList}" status="i" var="cardPlatformInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cardPlatformInstance.id}">${fieldValue(bean: cardPlatformInstance, field: "address")}</g:link></td>
