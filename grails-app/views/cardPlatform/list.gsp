...
<html>
	<head>
		...
		<title><g:message code="default.list.label" args="[entityName]" />商户信息表</title>
	</head>
	<body>
        ...
        <div style="padding:25px 12px">
            <div class="text-right collapse-button" style="padding:7px 3px;">
                <g:form controller="cardPlatform" action="search">
                    <input type="text" name="name" style="padding: 10px 23px " placeholder="请输入商户名" />
							...
							<div>
								<table>
									...
									<tr>
										...
										<g:sortableColumn property="name" title="${message(code: 'cardPlatform.name.label', default: '姓名')}" />
