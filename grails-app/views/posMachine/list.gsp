								...
								<table>
									...
									<g:each in="${posMachineInstanceList}" status="i" var="posMachineInstance">
										<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
											...
											<td><g:link action="show" id="${posMachineInstance.id}">${fieldValue(bean: posMachineInstance, field: "createTime")}</g:link></td>
											
											<td>${fieldValue(bean: posMachineInstance, field: "supplierId")}</td>
