					...
					<div class="block-flat">
						...
						<div class="content">
							...
							<g:form>
								...
								<g:link action="tEdit"  id="${ticketTypeInstance?.id}" params="[uTypeId:uTypeId]" class="btn btn-primary"><g:message code="default.button.edit.label" default="Edit" /></g:link>
								<g:actionSubmit class="btn btn-danger" action="tDelete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                                <g:link action="pCreate" params="[uTypeId:uTypeId]" class="btn btn-primary">创建pos机</g:link>
                            </g:form>
						</div>
					</div>
				</div>
