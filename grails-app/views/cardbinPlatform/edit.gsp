				...
				<div class="col-sm-12 col-md-12">
					<div class="block-flat">
						...
						<div class="content">
							...
							<g:hasErrors bean="${cardbinPlatformInstance}">
								<ul class="errors" role="alert">
									<g:eachError bean="${cardbinPlatformInstance}" var="error">
							...
							<g:form class="form-horizontal" role="form" action="save" >
								...
								<g:hiddenField name="version" value="${cardbinPlatformInstance?.version}" />
